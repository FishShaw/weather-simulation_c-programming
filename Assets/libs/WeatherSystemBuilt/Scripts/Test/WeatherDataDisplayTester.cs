...
namespace WeatherSystem.Testing
{
    public class WeatherDataDisplayTester : MonoBehaviour
    {
        ...
        [SerializeField] private SimpleWeatherManager weatherManager;
        ...
        private void Update()
        {
            ...
            WeatherData weatherData = dataLoader.GetInterpolatedWeatherData(currentTime);
        ...
        private void UpdateDebugInfo(WeatherData data, Vector2Int gridPos, DateTime time)
        {
            ...
            string info = 
                ...
                $"<b>Data Range</b>\n" +
                $"Rainfall Ratio: {(rainfall / WeatherData.RAINFALL_SCALE * 100):F1}%\n" +
                $"Wind Speed Ratio: {(windSpeed / MAX_WIND_SPEED * 100):F1}%\n\n" +
                
                $"<b>Additional Info</b>\n" +
                $"Data Source: KNMI HARMONIE\n" +
        ...
        // Get rainfall level description
        ...
        private void UpdateTextureDisplay(WeatherData data, Vector2Int gridPos)
        {
            ...
            if (rainfallDisplay != null && rainfallTexture != null)
            {
                ...
                Color rainfallColor = Color.Lerp(
                    Color.clear,  // 无雨时透明
                    Color.blue,   // 大雨时蓝色
                    rainfall / WeatherData.RAINFALL_SCALE * 5f  // 放大比例以便更好地观察
                );
                ...
                // Debug output
                Debug.Log($"Rainfall: {rainfall:F2} mm/h, Color: {rainfallColor}");
            }
            ...
            if (windDisplay != null && windTexture != null)
            {
                ...
                Color windColor = Color.HSVToRGB(
                    (windAngle + Mathf.PI) / (2 * Mathf.PI),  // 角度映射到色相
                    windSpeed / MAX_WIND_SPEED,               // 风速映射到饱和度
                    1f                                        // 保持最大亮度
                );
                ...
                // Debug output
                Debug.Log($"Wind: Speed={windSpeed:F2} m/s, Angle={windAngle:F2} rad, Color: {windColor}");
            }
        }
    }
}
