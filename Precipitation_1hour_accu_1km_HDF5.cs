...
public class Precipitation_1hour_accu_1km_HDF5 : MonoBehaviour
{
    ...
    private string baseUrl = "https://api.dataplatform.knmi.nl/open-data/v1/datasets/rad_nl25_rac_mfbs_01h/versions/2.0/files";
    ...
    IEnumerator FetchWeatherData()
    {
        ...
        DateTime endTime = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        ...
        using (UnityWebRequest webRequest = UnityWebRequest.Get(url))
        {
            ...
            if (files != null && files.Any())
            {
                ...
                foreach (var file in files)
                {
                    ...
                    // 只处理2023年的数据文件
                    if (fileName.Contains("20230101T000000_20240101T000000"))
                    {
